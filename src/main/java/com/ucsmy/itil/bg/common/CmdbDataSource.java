...
public class CmdbDataSource {
    ...
    private static CmdbDataSource instance = null;
    ...
    protected CmdbDataSource() {
    }

    public static CmdbDataSource newInstance() {
        if (instance == null) instance = new CmdbDataSource();
        return instance;
    }
